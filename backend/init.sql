-- KL Electricals — complete database setup, in one file.
--
...
CREATE DATABASE IF NOT EXISTS `kl_electricals`
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  urgency_reason varchar(60) DEFAULT NULL,
  delivery_slot_label varchar(40) DEFAULT NULL,
  delivery_slot_date date DEFAULT NULL,
  delivery_slot_time time DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS invoices (
  ...
  KEY fk_invoice_reviewer (reviewed_by),
  CONSTRAINT fk_invoice_reviewer FOREIGN KEY (reviewed_by) REFERENCES users (id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS cheques (
  ...
  CONSTRAINT fk_cheque_photo FOREIGN KEY (photo_id) REFERENCES attachments (id) ON DELETE SET NULL,
...
INSERT IGNORE INTO schema_migrations (filename) VALUES
  ('001_constraints_datetime_stock.sql'),
  ('002_lunch_autocheckout_noorder.sql'),
  ('003_order_workflow.sql'),
  ('004_payments_attachments.sql'),
  ('005_pricing_masters.sql'),
  ('006_attendance_payroll.sql'),
  ('007_purchase_git.sql'),
  ('008_scheme_incentive_estimates.sql'),
  ('009_challan_purchase_keys.sql'),
  ('010_cheques_transfers_photos.sql'),
  ('011_rate_change_approval.sql'),
  ('012_tally_sync.sql'),
  ('013_growth_schemes.sql'),
  ('014_return_penalty.sql'),
  ...
  ('024_purchase_rate_reason_claims.sql'),
  ('025_eod_second_confirm.sql');
